...
CARGO_TYPES = {
    "coconut_oil": {
        "type": "Agricultural - Vegetable Oil",
        "hs_code": "1513.11",
        "origin": "Indonesia",
        "packaging": "ISO-tank / Flexitank / 20L jerrycan",
        "unit": "MT",
        "halal_requirements": ["MUI certified", "No alcohol solvents", "Sunstone/Hydrogenated-free"],
    },
    "dates": {
        ...
        "unit": "MT",
        "halal_requirements": ["No sulfite preservatives", "Mashbuh-free processing"],
    },
    "palm_oil": {
        "type": "Agricultural - Edible Oil",
        "hs_code": "1511.90",
        "origin": "Indonesia / Malaysia",
        "packaging": "Flexitank / ISO-tank / Drums",
        "unit": "MT",
        "halal_requirements": ["MUI/JAKIM certified", "RSPO certified"],
    },
    "coffee_beans": {
        "type": "Agricultural - Green Coffee",
        "hs_code": "0901.11",
        "origin": "Ethiopia / Brazil / Vietnam",
        "packaging": "60kg GrainPro bags / Big bags",
        "unit": "MT",
        "halal_requirements": ["Halal storage segregation"],
    },
    "textiles": {
        "type": "Manufactured",
        "hs_code": "5209.42",
        "origin": "Bangladesh / India / Vietnam",
        "packaging": "Bales / Cartons",
        "unit": "CBM",
        "halal_requirements": ["OEKO-TEX certified", "No animal-derived fibers (silkworm, pig)"],
    },
}
